        ...
        **kwargs
        ...
        try:
            ...
            if use_rag and self.rag_service:
                ...
                if user_message and self.rag_service.should_use_rag(user_message):
            ...
            # Enforce word limit
            response = self._enforce_word_limit(response, 200)
        ...
        try:
            async with httpx.AsyncClient(timeout=self.timeout) as client:
                ...
                if response.status_code == 200:
                    ...
                    error_detail = f"Gemini API returned status {response.status_code}: {response.text}"
        ...
        return {
            ...
            "providers": {
                "gemini": {
                    ...
                    "message": "Gemini service is ready" if settings.GEMINI_API_KEY else "Gemini API key not configured"
                },
                "groq": {
            ...
            "rag_service": {
                "available": bool(self.rag_service),
                "message": "RAG service is ready" if self.rag_service else "RAG service not initialized"
            }
        }
